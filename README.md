...
ADSynth can generate classic on-premises AD, **hybrid identity environments** that include on-prem AD federated with Microsoft Entra ID (Azure AD). ADSynth also generate AD with non-human identities, AI agents, schema-validated invariants, and end-to-end reproducibility tooling.
